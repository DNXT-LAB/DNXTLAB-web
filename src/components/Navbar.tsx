...
useEffect(() => {
  ...
  return (
    <nav
      className="relative fixed top-0 left-0 w-full flex items-center justify-between transition-colors duration-500 lg:px-12"
      role="navigation"
    ...
    >
      ...
      >
        ...
        />
        <span
          className={`text-2xl md:text-4xl lg:text-6xl font-bold font-poppins transition-colors duration-500 ${
      ...
      <div className="hidden md:flex justify-end items-center">
        ...
        >
          {/* Animated Menu Items */}
          <div
            className={`flex items-center transition-all duration-500 ease-in-out overflow-hidden whitespace-nowrap ${
              isMenuOpen ? "max-w-xl px-6" : "max-w-0"
            }`}
          >
            <div className="flex items-center space-x-6">
              <button
                onClick={() => handleNavigation(0)}
                className={`text-base lg:text-lg font-normal font-morien hover:opacity-70 transition-opacity ${
                  isDark ? "text-black" : "text-white"
                }`}
              >
                HOME
          ...
          >
            <div className="relative w-6 h-6 flex flex-col justify-center items-center">
              ...
              ></div>
              <div
                className={`w-7 h-0.5 transition-all duration-300 ease-in-out ${
                  isDark ? "bg-black" : "bg-white"
                } ${
      ...
      >
        <div className="flex flex-col w-full h-full p-8 relative">
          ...
          {/* Menu options - Top */}
          <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left space-y-28 md:space-y-8 md:mt-0 navbar-main-container">
            <button
              onClick={() => handleNavigation(0)}
              className="text-white text-xl font-normal font-morien text-left m-0"
            >
              HOME
            </button>

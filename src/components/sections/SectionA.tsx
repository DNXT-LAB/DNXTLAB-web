...
> = ({
  ...
  const getScaledDimensions = () => {
    ...
    return {
      ...
      text: {
        ...
        left: baseTextLeft,
        top: `calc(50% - ${
          (getResponsiveTextTopBase() * scaleFactor) / 2
        }px + ${44.5 * scaleFactor}px)`,
      },
    };
  };
  ...
  const sectionStyle: React.CSSProperties = {
    ...
    transition:
      "opacity 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94), visibility 0.8s ease",
  ...
  const videoStyle: React.CSSProperties = {
    ...
    transform: `translateY(${
      sectionATranslateY + videoConvergeY
    }px) translateX(${videoConvergeX}px) scale(${sectionAScale})`,
  ...
  const textStyle: React.CSSProperties = {
    ...
    transform: `translateY(${
      sectionATranslateY + textConvergeY
    }px) translateX(${textConvergeX}px) scale(${sectionAScale})`,
    transformOrigin: "center center",
    // opacity: secondSmoothProgress > 0.7 ? 0 : 1 - (secondSmoothProgress * 1.2)
  };
    ...
    <div style={sectionStyle}>
      ...
      <div className="hidden 2xl:block">
        ...
        >
          ...
          >
            At DNXT LAB, we create intelligent digital solutions that think,
            adapt, and scale—combining AI automation, UX strategy, and
            high-performance web design to help you launch faster, work smarter,
            and grow stronger.
          </p>
          <button
      ...
      <div
        className="block lg:hidden w-full flex flex-col items-center px-4 md:px-8 pt-8 sm:flex flex-wrap flex-row
